...
## A new version of this discord invite logger is available in the newest version of djs (v14) in the [discord-plugins-bot repository](https://github.com/azynux/discord-plugins-bot) which is a plugins bot. The invite logger plugin has been updated to match with this plugins bot.
